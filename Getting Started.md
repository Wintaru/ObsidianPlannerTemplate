...
Add tasks anywhere and they'll show up in the [[Task Dashboard]].

```
- [ ] Basic task
- [ ] Task with due date 📅 2026-03-15
- [ ] Urgent task 📅 2026-03-10 ⏫
- [ ] Recurring standup 🔁 every weekday 📅 2026-03-10
- [x] Completed task ✅ 2026-03-09
```
...
- `#tag` or `#project/tenzing` — add a searchable tag
...
Each project has a **hub note** — a central page that links to all related docs, tracks team members, and summarizes current work. Use `[[Project Name]]` anywhere to link to it.

| Project | Hub Note | Tag |
|---------|----------|-----|
| Tenzing | [[Tenzing]] | `#project/tenzing` |
| Haberfeld | [[Haberfeld]] | `#project/haberfeld` |
| Settlement Streams | [[Settlement Streams]] | `#project/settlement-streams` |
| Social Assurance | [[Social Assurance]] | `#project/social-assurance` |
| Teammates | [[Teammates]] | `#project/teammates` |

## Contacts

The `Contacts/` folder has a note per person you work with. Each note tracks their role, projects, and meeting history. When you mention someone in a daily note or meeting note, link them: `[[Josh B]]`, `[[Chad]]`, etc. — backlinks will automatically build a history of every interaction.

**Current contacts**: [[Josh B]], [[Mike]], [[Greg]], [[Diane]], [[Scott]], [[Anne]], [[Nick]], [[Chris]], [[Everett]], [[Ben]], [[Chad]], [[Andre]], [[Niemann]]
...
- **Link liberally** — mention Haberfeld? Write `[[Haberfeld]]`. This builds your knowledge graph.
- **Use callouts** for important info:
  ```
  > [!warning] Don't forget
  > Follow up with Josh B for reCAPTCHA keys
  ```
